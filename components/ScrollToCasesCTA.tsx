    ...
    <div className="w-full px-6 md:px-14 flex justify-center">
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="group flex items-center gap-4 bg-white border border-black/5 pl-5 pr-3.5 py-2.5 md:pl-6 md:pr-4 md:py-3 rounded-surface shadow-[0_20px_50px_-15px_rgba(0,0,0,0.12)] hover:shadow-[0_30px_60px_-15px_rgba(16,185,129,0.2)] transition-all duration-700"
        >
