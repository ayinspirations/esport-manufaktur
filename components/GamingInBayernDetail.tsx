          ...
          <div className="lg:col-span-8 space-y-12 md:space-y-16">
            <section>
              ...
              <p className="text-lg md:text-2xl font-medium leading-relaxed text-slate-700">
                Gaming in Bayern ist eines der größten Gaming-Events im Süddeutschland. Unter dem Motto "Gamers United" bringen wir Spieler aus ganz Bayern zusammen und schaffen eine Plattform für den Gaming-Nachwuchs.
              </p>
              <p className="text-lg md:text-2xl font-medium leading-relaxed text-slate-700 mt-6">
                Mit hochmodernen Gaming-Setups, professionellem Livestream und interaktiven Spielstationen bieten wir ein unvergessliches Erlebnis für Gamer jeder Leistungsstufe.
              </p>
            </section>
                ...
                <AnimatePresence initial={false} custom={direction}>
                  ...
                  >
                    <img
                      ...
                      onError={(e) => {
                        e.currentTarget.src = 'https://images.unsplash.com/photo-1538481143235-c8f91f7a01e7?auto=format&fit=crop&q=80&w=1200';
                      }}
                    />
                  </motion.div>
                </AnimatePresence>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
              {[
                { title: 'Konzeptentwicklung', icon: <Target className="w-6 h-6" />, text: 'Strategische Planung des großen Gaming-Events' },
                { title: 'Event Production', icon: <Users className="w-6 h-6" />, text: 'Professionelle Umsetzung mit modernstem Equipment' },
                { title: 'Turniermanagement', icon: <Trophy className="w-6 h-6" />, text: 'Organisation von Wettbewerben in verschiedenen Spielen' },
                { title: 'Community Management', icon: <Lightbulb className="w-6 h-6" />, text: 'Betreuung und Aktivierung der Gaming-Community' },
              ].map((item, i) => (
                ...
                <div className="space-y-10">
                  ...
                  <section>
                    ...
                    <div className="space-y-2">
                      <h4 className="text-lg font-black text-emerald-400 leading-tight">Event Production</h4>
                      <p className="text-white/70 font-bold uppercase tracking-widest text-[10px]">Regional · Gaming · Großveranstaltung</p>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    <ul className="space-y-6">
                      {[
                        { title: 'Event-Planung', desc: 'Strategisches Konzept und Dramaturgie' },
                        { title: 'Technische Umsetzung', desc: 'Gaming-Setups, Livestream & Streaming-Infrastruktur' },
                        { title: 'Turniermanagement', desc: 'Wettkampfleitung und faire Spielsysteme' },
                        { title: 'Community Activation', desc: 'Engagement und Interaction der Gamer' }
                      ].map((item, i) => (
                        <li key={i}>
                  ...
                  <section>
                    ...
                    <ul className="space-y-4">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-white font-black">Große Reichweite in der Gaming-Community</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <Target className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                        <span className="text-white font-black">Starke Markenpositionierung</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <Trophy className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                        <span className="text-white font-black">Erfolgreiche Community-Aktivierung</span>
                      </li>
                    </ul>
                  </section>
